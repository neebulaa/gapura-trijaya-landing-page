import IconInstagram from '@/commons/assets/icons/IconInstagram';
import IconMaidotru from '@/commons/assets/icons/IconMaildotru';
import IconWhatsapp from '@/commons/assets/icons/IconWhatsapp';
        ...
        <section id="footer">
          ...
          <section className="footer-info">
            <div className="footer-info-left">
              {/* <h3>Gapura</h3> */}
              <img
                src={`${import.meta.env.VITE_APP_URL}./images/logo-horizontal.png`}
                alt={`${import.meta.env.VITE_APP_NAME} - logo horizontal`}
                style={{
                  width: '136px',
                  height: '36px',
                  objectFit: 'contain',
              ...
              <p className="flex gap-05">
                ...
                Jl. Jl. Sumatera Gg. Sederhana, Akcaya, Kec. Pontianak Sel., Kota Pontianak,
          ...
          <section className="footer-copyright">
            <div className="copyright-text">
              © {new Date().getFullYear()} Gapura Digital Indonesia
            </div>
