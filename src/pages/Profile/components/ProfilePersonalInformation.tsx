      ...
      <form>
        <div className="split-item gap-1">
          <div className="input-box w-100">
            ...
            <input type="text" id="firstName" name="firstName" placeholder="Edwin" />
          </div>
          <div className="input-box w-100">
            <label htmlFor="lastName">
              Last Name <span className="muted italic">(optional)</span>
            </label>
            <input type="text" id="lastName" name="lastName" placeholder="Hendly" />
          </div>
        </div>
        <div className="input-box w-100 mt-1-05">
          ...
          <input type="email" id="email" name="email" placeholder="edwinhendly@gmail.com" />
        </div>
        <div className="input-box w-100 mt-1-05">
        ...
        <div className="input-box w-100 mt-1-05">
          ...
          <div className="flex gap-1">
            <label htmlFor="gender-male" className="btn-link flex items-center gap-05">
              <input
                type="radio"
                style={{
                  width: '15px',
            ...
            <label htmlFor="gender-female" className="btn-link flex items-center gap-05">
              <input
                type="radio"
                style={{
                  width: '15px',
