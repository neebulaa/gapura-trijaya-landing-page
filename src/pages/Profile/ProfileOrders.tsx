		...
		<section className="profile-orders">
			...
			<section className="profile-orders-content">
				{orders.length > 0 &&
					orders.map((order) => (
						<div
							className="profile-orders-content-card"
							key={order.id}
						>
								...
								>
									...
									<ul className="card-bordered detail-order-progress">
										{Object.entries(detailOrderProgress)
											...
											.map(([_, progress], i) => (
												<li key={i}>
													<div className="detail-order-date">
														{progress.date}
													</div>
							...
							{openModalReviewOrders.find(
								...
								>
									...
									<button className="btn w-100 mt-1-05">
										Save
									</button>
								</AppModal>
							)}
				...
				{orders.length == 0 && (
					<p className="mt-1">No order with status {status}</p>
				)}
			</section>
		</section>
	);
