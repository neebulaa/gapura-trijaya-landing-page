		...
		if (formData.paket != "non-paket") {
			...
			switch (true) {
				case jumlahLembar >= 1 && jumlahLembar <= 5:
					return 18000;
				case jumlahLembar > 5 && jumlahLembar <= 50:
					return 15000;
				case jumlahLembar > 50 && jumlahLembar <= 100:
					return 12000;
				case jumlahLembar > 100 && jumlahLembar <= 200:
					return 10000;
				case jumlahLembar > 200 && jumlahLembar <= 500:
					return 8000;
	...
	return (
		<form action="">
			<img
				...
				}./images/product-supporting-images/stiker-kromo.png`}
				alt={`${
